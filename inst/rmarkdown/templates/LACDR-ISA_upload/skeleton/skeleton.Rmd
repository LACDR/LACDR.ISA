...
We advice you to read the rspacer Get started website on https://lacdr.github.io/rspacer to make sure that you are ready to use this upload document. You need to install rspacer and set up your API url and API key before this script is will run.
